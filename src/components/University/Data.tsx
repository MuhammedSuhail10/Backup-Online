...
export default function UniversityData() {
    ...
    return (
            <div className="font-[family-name:var(--font-montserrat)] md:px-[15em] px-[0.5em] my-[1.5em] ">
                ...
                {/* Courses */}
                <div className="my-[1.5em] ">
                    <h1 className="md:text-[25pt] text-[18pt] font-[700] ">Courses at IGNOU</h1>
                    <div className="flex flex-wrap gap-x-[2em] my-[-1em] mb-[1.5em] items-center ">
                    ...
                    <div className="h-[2em] flex md:hidden justify-center items-center ">
                        <ButtonUi text="View More" py="md:py-[0.8em] py-[0.7em] " />
                    </div>
                </div>
                ...
                {/* Exam */}
                <div className="my-[1.5em] ">
                    <h1 className="md:text-[25pt] text-[18pt] font-[700] ">Exam Information</h1>
                    <ul className="list-disc list-inside space-y-2 text-gray-600 my-[0.5em] ">
                        {exams.map((exam) => (
                            <li key={exam.id}>
                ...
                {/* Placements */}
                <div className="my-[1.5em] ">
                    <h1 className="md:text-[25pt] text-[18pt] font-[700] ">Top Placements</h1>
                </div>
            </div>
    )
}