...
export default function HomePage() {
    return (
        <div className='font-[family-name:var(--font-montserrat)] md:h-[90vh] h-[70vh] bg-gradient-to-br dark:from-gray-800 dark:to-indigo-900 to-blue-900 relative overflow-hidden'>
            <div className='md:h-[14vh] h-[11vh] '></div>
            ...
            <div className='flex justify-between md:px-[12em] px-[1em] md:h-[75vh] h-[1vh] '>
                <div className='md:h-[60vh] flex flex-col justify-center z-1 '>
                    <h1 className='text-4xl md:text-[45pt] text-center md:text-start font-semibold dark:text-white leading-[40px] md:leading-tight '>A Backup Platform for Individuals</h1>
                    <h2 className='text-xl md:text-2xl text-center md:text-start dark:text-[#d3d3d3] text-grey-800 font-[family-name:var(--font-poppins)] '>Persue professional courses with our guidance</h2>
                    <div className='mt-[1em] hidden md:block '>
                        <ButtonUi text='Consult Us' py='py-[1em]' />
                    </div>
                </div>
                <div className="lg:w-1/2 w-[17em] md:relative absolute bottom-0 left-20 z-0 ">
                    <img 
                        src="/PersonImage.png"
