...
export default function Conseltation({ text = "Schedule a One to One Section", bg = "dark:bg-[#343a40] bg-[#dee2e6]" }: { text?: string, bg?: string }) {
    return (
        <div className="md:px-[3em] font-[family-name:var(--font-montserrat)] mb-[2em] ">
            <div className={`${bg} md:h-[30dvh] h-[35dvh] rounded-xl flex md:flex-row flex-col md:items-center justify-center md:px-[8em] px-[1em] relative `}>
