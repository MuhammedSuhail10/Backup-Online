...
export default function Conseltation({ text = "Schedule a One to One Section" }: { text?: string }) {
    return (
        <div className="md:px-[3em] font-[family-name:var(--font-montserrat)] mb-[2em] ">
            <div style={{ backgroundColor: color.tertiaryColor, boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }} className={` md:h-[30dvh] h-[35dvh] rounded-xl flex md:flex-row flex-col md:items-center justify-center 2xl:px-[8em] md:px-[2.5em] px-[1em] relative `}>
                ...
                <div className="md:w-1/3 flex md:flex-col justify-center gap-[1em] md:mt-0 mt-[1.5em] items-center font-[family-name:var(--font-poppins)]">
                    <Link href="tel:+919497428107" style={{ backgroundColor: color.primaryColor, boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }} className=' text-[13pt] text-[#fff] md:w-[60%] w-[45%] flex items-center gap-[0.3em] justify-center md:h-[3.5em] h-[3em] rounded-[20px] '>
                    ...
                    <Link href="https://wa.me/919497428107?text=Hi%20there!%20I%27d%20love%20to%20know%20more%20about%20the%20courses%20from%20IGNOU.%20Looking%20forward%20to%20join." target="_blank" rel="noopener noreferrer" style={{ color: color.primaryColor, boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }} className=' text-[13pt] bg-[#fff] md:w-[60%] w-[45%] flex items-center gap-[0.3em] justify-center md:h-[3.5em] h-[3em] rounded-[20px] '>
